package com.sunsh.myapplication.overscroll.footer;
...
import com.sunsh.myapplication.overscroll.NestedFrameLayout;
import com.sunsh.myapplication.overscroll.NestedOverScrollLayout;
import com.sunsh.myapplication.overscroll.OverScrollUtils;
import com.sunsh.myapplication.overscroll.ShowGravity;
import com.sunsh.myapplication.overscroll.ViscousInterpolator;
import com.sunsh.myapplication.overscroll.pathview.ProgressDrawable;
...
public class ClassicHoldLoadView extends NestedFrameLayout implements NestedOverScrollLayout.OnPullListener {


    public static String LOADING = "加载中...";
    public static String LOADING_COMPLETE = "加载完成";

    private NestedOverScrollLayout refreshLayout;
    ...
    public ClassicHoldLoadView(@NonNull Context context, final NestedOverScrollLayout refreshLayout) {
        super(context);

 ...
 */
public class ClassicsFooter extends NestedRelativeLayout implements NestedOverScrollLayout.OnPullListener {
    ...
    public ClassicsFooter(Context context, NestedOverScrollLayout overScrollLayout) {
        super(context);

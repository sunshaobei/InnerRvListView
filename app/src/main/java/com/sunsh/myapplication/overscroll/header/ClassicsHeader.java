package com.sunsh.myapplication.overscroll.header;
...
import com.sunsh.myapplication.overscroll.NestedRelativeLayout;
 ...
 */
public class ClassicsHeader extends NestedRelativeLayout implements NestedOverScrollLayout.OnPullListener {
    ...
    private NestedOverScrollLayout overScrollLayout;

    public ClassicsHeader(NestedOverScrollLayout overScrollLayout) {
        super(overScrollLayout.getContext());
        this.overScrollLayout = overScrollLayout;
        this.initView(overScrollLayout.getContext(),null);
    }

    public ClassicsHeader(NestedOverScrollLayout overScrollLayout, String simpleNmae, AttributeSet attrs) {
